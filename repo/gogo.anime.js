...
// @package      gogo.anime
// @type         bangumi
// @webSite      https://api-consumet-6adls650k-saurabhgangule.vercel.app/anime/gogoanime
// ==/MiruExtension==
...
export default class extends Extension {
  ...
  async load() {
    this.registerSetting({
      ...
      type: "input",
      description: "API URL",
      defaultValue: "https://api-consumet-6adls650k-saurabhgangule.vercel.app/anime/gogoanime",
    });
    this.registerSetting({
