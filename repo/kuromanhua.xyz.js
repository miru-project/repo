...
export default class extends Extension {
    ...
    async load() {
		this.registerSetting({
			title: "Kuromanhua.xyz",
			key: "domain_kuromanhua.xyz",
			type: "input",
			description: "Kuromanhua.xyz Domain",
			defaultValue: "https://kuromanhua.xyz",
		});
    }
    async requestWSetting(url) {
		return this.request(url, {
			headers: {
				"Miru-Url": await this.getSetting("domain_kuromanhua.xyz"),
			},
		});
	}
    async get_filter(){
